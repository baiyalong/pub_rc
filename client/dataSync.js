...
Template.dataSync.helpers({
    recordList: function() {
        return DataStationHourlyReSyncRecord.find({}, { sort: { tStart: -1 }, limit: Session.get('limit') }).map(function(e) {
            return {
                _id: e._id,
...
Template.dataSync.onCreated(function() {
    ...
    Tracker.autorun(function() {
        Meteor.subscribe('dataStationHourlyReSyncRecord', Session.get('limit'));
    });
}
);