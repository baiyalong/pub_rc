    ...
    airQualityForcast: function () {
        return {
            ...
            date:(function(){
                ...
                var d = DataAirQuality.findOne({description:{$exists:false}},{sort:{date:1}})
                if(d){
                    var dd = d.date;
            ...
            detail: (function () {
                var data = DataAirQuality.find({description:{$exists:false}}, { sort: { areaCode: 1,date:1 },fields:{_id:0} }).map(function(e){
    ...
    cityDetail: function (id) {
        ...
        return {
            ...
            airQualityForecast: (function () {
                return DataAirQuality.find({description:{$exists:false}, areaCode: { $gt: id, $lt: id + 100 } }).map(function (e) {
                    return {
